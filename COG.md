...
type: cog [0.1]
name: cog-claude
description: Provides Claude through Claude Code as an inseparable Model+Harness Cog.
version: "0.1.0"
license: Apache-2.0
publisher: OpenTeams
manifest: cog.yaml
...
Provides Claude through Claude Code as an inseparable Model+Harness Cog.
